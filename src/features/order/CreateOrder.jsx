    ...
    <div>
      ...
      <Form method="POST">
        <div>
          ...
          <input type="text" name="customer" required className="border" />
        </div>

        <div>
          <label>Phone number</label>
          <div>
            <input className="border" type="tel" name="phone" required />
          </div>
        ...
        <div>
          <button
            ...
            type="submit"
            className="inline-block rounded-full border bg-yellow-400 px-4 py-2 font-semibold uppercase tracking-wider text-stone-800 
